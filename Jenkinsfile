pipeline {
    agent any
    environment {
        DOCKER_IMAGE = "nadheemm/docker-app:latest"  // Change this to your registry
        CONTAINER_NAME = "docker-running-app"
        REGISTRY_CREDENTIALS = "docker-nadheem"  // Jenkins credentials ID
    }
    ...
    stages {
        ...
        stage('Login to Docker Registry') {
            steps {
                withCredentials([usernamePassword(credentialsId: 'docker-nadheem', usernameVariable: 'DOCKER_USER', passwordVariable: 'DOCKER_PASS')]) {
